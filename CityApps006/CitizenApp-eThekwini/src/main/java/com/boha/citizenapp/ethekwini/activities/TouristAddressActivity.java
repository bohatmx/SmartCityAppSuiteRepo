...
public class TouristAddressActivity extends AppCompatActivity implements AddressFragment.AddressFragmentListener{

    AddressFragment addressFragment;
    int type;
    Menu mMenu;
    public static final int CALLED_FROM_TOURIST_DRAWER_ACTIVITY = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tourist_address);
    ...
    public void onAddressUpdated() {
        Intent w = new Intent(getApplicationContext(), TouristDrawerActivity.class);
        startActivity(w);
        finish();
    }

...
public class ComplaintTypePopupListAdapter extends ArrayAdapter<ComplaintTypeDTO> {
    ...
    static final String LOG = ComplaintTypePopupListAdapter.class.getSimpleName();

    public ComplaintTypePopupListAdapter(Context context, int textViewResourceId,
                                         List<ComplaintTypeDTO> list, int primaryColorDark) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        item.txtString.setText(p.getComplaintTypeName());

        Util.setComplaintTypeIcon(p.getComplaintTypeName(),item.image, ctx);

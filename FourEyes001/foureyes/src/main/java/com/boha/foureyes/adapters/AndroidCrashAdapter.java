...
public class AndroidCrashAdapter extends ArrayAdapter<ErrorStoreAndroidDTO> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (p.getMunicipalityStaff() != null) {
            vhItem.txtStaff.setText(p.getMunicipalityStaff().getFirstName() + " " + p.getMunicipalityStaff().getLastName());
        ...
        vhItem.txtErrorDate.setText(y.format(p.getErrorDate()));
